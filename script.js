...
const healthData = {
    ...
    "i have a cough": "For a cough, try drinking warm water with honey and lemon. Avoid cold drinks and rest. If the cough persists for more than a week or is accompanied by fever, consult a doctor.",
    ...
    "i have a cold": "For a cold, drink plenty of fluids, rest, and consider over-the-counter remedies like saline nasal drops. If symptoms worsen or last more than 10 days, see a doctor.",
    ...
    "i have a fever": "For a fever, rest and stay hydrated. You can take paracetamol to reduce the fever. If the fever is above 102°F or lasts more than 3 days, consult a doctor.",
    ...
    "my throat hurts": "For a sore throat, gargle with warm salt water and drink warm liquids like herbal tea. If the pain persists for more than 3 days, consult a doctor.",
    ...
    "i have a headache": "For a headache, rest in a dark room, drink water, and consider taking a pain reliever like ibuprofen. If the headache is severe or persistent, consult a doctor.",
    ...
    "my stomach hurts": "For a stomach ache, avoid heavy meals and drink herbal tea like peppermint or ginger tea. If the pain is severe or lasts more than a day, consult a doctor.",
    ...
    "i have diarrhea": "For diarrhea, drink plenty of fluids to stay hydrated and eat bland foods like bananas, rice, and toast. If it lasts more than 2 days, consult a doctor.",
    ...
    "i am constipated": "For constipation, drink plenty of water, eat fiber-rich foods like fruits and vegetables, and exercise regularly. If it persists, consult a doctor.",
    ...
    "my back hurts": "For back pain, rest, apply a warm compress, and do gentle stretches. If the pain is severe or lasts more than a week, consult a doctor.",
    ...
    "my leg hurts": "For leg pain, rest, elevate your legs, and apply a warm compress. If the pain is severe or persists, consult a doctor.",
    ...
    "period cramps": "For period pain, try the following remedies: \n1. Apply a heating pad or hot water bottle to your lower abdomen. \n2. Take over-the-counter pain relievers like ibuprofen or paracetamol. \n3. Drink herbal teas like chamomile or ginger tea. \n4. Exercise lightly, such as walking or yoga, to improve blood flow. \n5. Avoid caffeine and salty foods. \nIf the pain is severe or disrupts your daily activities, consult a doctor.",
    ...
    "heartburn": "For acid reflux, avoid spicy and fatty foods, eat smaller meals, and avoid lying down immediately after eating. You can also try over-the-counter antacids. If symptoms persist, consult a doctor.",
    ...
    "i have allergies": "For allergies, avoid allergens, take antihistamines, and use a saline nasal spray. If symptoms are severe or you experience difficulty breathing, seek medical attention immediately.",
    ...
    "feeling anxious": "For anxiety, practice deep breathing exercises, meditation, or yoga. Avoid caffeine and try to get enough sleep. If anxiety persists or worsens, consult a mental health professional.",
    ...
    "asthma attack": "For asthma, use your inhaler as prescribed. Avoid triggers like smoke, dust, or pollen. If you experience severe difficulty breathing, seek emergency medical help.",
    ...
    "uti": "For a bladder infection, drink plenty of water and cranberry juice. Avoid caffeine and alcohol. If symptoms like pain or burning persist, consult a doctor.",
    ...
    "i have a bruise": "For bruises, apply a cold compress to reduce swelling. After 24 hours, use a warm compress to improve blood flow. If the bruise is large or painful, consult a doctor.",
    ...
    "i got a burn": "For minor burns, run cool water over the area for 10-15 minutes and apply aloe vera gel. Avoid popping blisters. If the burn is severe, seek medical attention.",
    ...
    "my ear hurts": "For an earache, apply a warm compress to the affected ear. Avoid inserting objects into the ear. If the pain persists or is accompanied by fever, consult a doctor.",
    ...
    "my eyes are tired": "For eye strain, follow the 20-20-20 rule: every 20 minutes, look at something 20 feet away for 20 seconds. Use artificial tears if your eyes feel dry. If symptoms persist, consult an eye doctor.",
    ...
    "thankyou": "You're welcome! If you have any health-related questions or need information in the future, feel free to ask. Have a good day!",
    "nice to meet you": "Nice to meet you too! I'm here to help if you have any health concerns or questions. Just let me know how I can assist you.",
    "exercise physical activity": "Regular physical activity has numerous health benefits. Aim for at least 150 minutes of moderate-intensity or 75 minutes of vigorous-intensity aerobic activity per week, plus muscle-strengthening activities at least two days a week.",
    "healthy diet, good nutrition": "A balanced diet rich in fruits, vegetables, whole grains, and lean protein is essential for good health.",
    "how can you help me?":"I can provide general information and suggestions for common health concerns like coughs, colds, headaches, stomach aches, and more. If you describe your symptoms, I will try to offer relevant advice. However, please remember that I am not a substitute for a medical professional, and my advice should not be taken as a diagnosis or treatment plan. If you have serious or persistent symptoms, please consult a doctor."
    // Add more entries here with various phrasings
};
...
async function handleUserInput(message = null) {
    const userMessage = message !== null ? message : userInput.value.trim().toLowerCase();
    ...
    for (const key in healthData) {
        if (userMessage.includes(key)) {
            directResponse = healthData[key];
            break; // Stop after finding the first match
        }
    }

    if (directResponse) {
        addMessage(directResponse, false);
    } else {
        addMessage("Sorry, I couldn't understand that. Please try rephrasing your question.", false);
    }
}
...
if (microphoneBtn && recognition) {
    microphoneBtn.addEventListener("click", () => {
        try {
            recognition.start();
        } catch (error) {
            console.error("Error starting speech recognition:", error);
            addMessage("Error starting microphone. Please try again later.", false);
        }
    });
    ...
    recognition.onerror = (event) => {
        ...
        addMessage("Sorry, I couldn't understand that through the microphone. Please try typing.", false);
    };
} else if (microphoneBtn) {
